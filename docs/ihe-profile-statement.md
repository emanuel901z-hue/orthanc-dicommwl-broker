...
| **Patient Information Reconciliation (PIR)** | **ja** (A40 + manuell) | Identifier werden übernommen, je Fall zusammengeführt (Dedupe über PatientID+Accession+SPS) und **zusammengeführt**: `ADT^A40` oder manuell eintragen; Arbeitsliste **und** Routing-Herkunft folgen der aktuellen ID, rücknehmbar. Nicht enthalten: die Link/Unlink-Events A24/A47 und PIX/PDQ-Abfragen |
