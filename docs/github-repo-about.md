...
ATNA-Export, DICOM-TLS/mTLS, RBAC und Aufbewahrungskonzepte. 585 Backend-Tests.
```
...
- `npm run test` — 590 Unit-Tests (Vitest), `npm run i18n:check`, `tsc`, ESLint
- Playwright: 55 Stack-Tests (Desktop + Mobile), `verify-ui.cjs`: 146 Checks
- Backend des Brokers: 585 pytest-Tests (96 % Coverage) im Schwester-Repo
```
