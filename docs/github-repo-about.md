...
ATNA-Export, DICOM-TLS/mTLS, RBAC und Aufbewahrungskonzepte. 398 Backend-Tests.
```
...
- `npm run test` — 490 Unit-Tests (Vitest), `npm run i18n:check`, `tsc`, ESLint
- Playwright: 55 Stack-Tests (Desktop + Mobile), `verify-ui.cjs`: 127 Checks
- Backend des Brokers: 398 pytest-Tests (96 % Coverage) im Schwester-Repo
```
