...
ATNA-Export, DICOM-TLS/mTLS, RBAC und Aufbewahrungskonzepte. 610 Backend-Tests.
```
...
- `npm run test` — 595 Unit-Tests (Vitest), `npm run i18n:check`, `tsc`, ESLint
- Playwright: 55 Stack-Tests (Desktop + Mobile), `verify-ui.cjs`: 150 Checks
- Backend des Brokers: 610 pytest-Tests (96 % Coverage) im Schwester-Repo
```
